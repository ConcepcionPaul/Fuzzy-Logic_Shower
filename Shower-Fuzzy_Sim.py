...
def main():
    ...
    label_factory(canvas, 'Initial Water (°C)', relx=0.825, rely=0.045)
    ...
    label_factory(canvas, 'Shower Heater (°C)' , relx=0.825, rely=0.345)
    ...
    root.after(150, calculate_shower_temp)
